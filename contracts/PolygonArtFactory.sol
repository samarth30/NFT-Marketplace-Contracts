...
import "./PolygonArtTradable.sol";

contract PolygonArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new PolygonArtTradable contract
        ...
        returns (address)
    {
        ...
        PolygonArtTradable nft = new PolygonArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
