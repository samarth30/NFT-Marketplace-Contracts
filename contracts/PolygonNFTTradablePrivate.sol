...
/**
 * @title PolygonNFTTradablePrivate
 * PolygonNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract PolygonNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist Polygon contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Polygon auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Polygon contracts to enable gas-less listings.
     */
