...
/**
 * @title PolygonArtTradablePrivate
 * PolygonArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract PolygonArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // Polygon Marketplace contract
    address marketplace;
    // Polygon Bundle Marketplace contract
    ...
    {
        // Whitelist Polygon marketplace, bundle marketplace contracts for easy trading.
