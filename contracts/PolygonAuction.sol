 ...
 */
contract PolygonAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event PolygonAuctionContractDeployed();
        ...
        initializer
    {
        ...
        emit PolygonAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        IPolygonMarketplace marketplace = IPolygonMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            IPolygonMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
