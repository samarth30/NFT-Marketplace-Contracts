...
/**
 * @title PolygonNFTTradable
 * PolygonNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract PolygonNFTTradable is ERC721, Ownable {
