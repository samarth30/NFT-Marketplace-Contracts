...
import "./PolygonArtTradablePrivate.sol";

contract PolygonArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new PolygonArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        PolygonArtTradablePrivate nft = new PolygonArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing PolygonArtTradable contract
    ...
    /// @notice Method for disabling existing PolygonArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
