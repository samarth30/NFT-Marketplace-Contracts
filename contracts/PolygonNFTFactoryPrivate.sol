...
import "./PolygonNFTTradablePrivate.sol";

contract PolygonNFTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Polygon auction contract address;
    address public auction;

    /// @notice Polygon marketplace contract address;
    address public marketplace;

    /// @notice Polygon bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new PolygonNFTTradable contract
        ...
        returns (address)
    {
        ...
        PolygonNFTTradablePrivate nft = new PolygonNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing PolygonNFTTradable contract
    ...
    /// @notice Method for disabling existing PolygonNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
