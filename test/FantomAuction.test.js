...
const PolygonNFT = artifacts.require("PolygonNifty");
const PolygonAuction = artifacts.require("PolygonAuctionMock");
const PolygonAuctionReal = artifacts.require("PolygonAuction");
const BiddingContractMock = artifacts.require("BiddingContractMock");
const MockERC20 = artifacts.require("MockERC20");

contract("PolygonAuction", (accounts) => {
  const [
    admin,
    smartContract,
    platformFeeAddress,
  ...
  beforeEach(async () => {
    this.token = await PolygonNFT.new({ from: admin });
    ...
    this.auction = await PolygonAuction.new(platformFeeAddress, {
      from: admin,
    });
  ...
  describe("Contract deployment", () => {
    it("Reverts when platform fee recipient is zero", async () => {
      await expectRevert(
        PolygonAuction.new(constants.ZERO_ADDRESS, { from: admin }),
        "PolygonAuction: Invalid Platform Fee Recipient"
      );
    });
  });
    ...
    describe("validation", async () => {
      ...
      it("fails if endTime is in the past", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.createAuction: End time passed. Nobody can bid."
        );
      });
      ...
      it("fails if endTime greater than startTime", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.createAuction: End time must be greater than start"
        );
      });
      ...
      it("fails if token already has auction in play", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.createAuction: Cannot relist"
        );
      });
      ...
      it("fails if you dont own the token", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.createAuction: Not owner and or contract not approved"
        );
      });
    ...
    describe("validation", () => {
      ...
      it("will revert if sender is smart contract", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.placeBid: No contracts permitted"
        );
      });
      ...
      it("will fail with 721 token not on auction", async () => {
        await expectRevert(
          ...
          "PolygonAuction.placeBid: Bidding outside of the auction window"
        );
      });
      ...
      it("will fail when outbidding someone by less than the increment", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.placeBid: Failed to outbid highest bidder"
        );
      });
    });
  ...
  describe("withdrawBid()", async () => {
    ...
    it("fails with withdrawing a bid which does not exist", async () => {
      await expectRevert(
        ...
        "PolygonAuction.withdrawBid: You are not the highest bidder"
      );
    });
    ...
    it("fails with withdrawing when lockout time not passed", async () => {
      ...
      await expectRevert(
        ...
        "PolygonAuction.withdrawBid: Cannot withdraw until lock time has passed"
      );
    });
    ...
    it("fails when withdrawing after auction end", async () => {
      ...
      await expectRevert(
        ...
        "PolygonAuction.withdrawBid: Past auction end"
      );
    });
    ...
    describe("validation", () => {
      ...
      it("cannot result if not an owner", async () => {
        await expectRevert(
          ...
          "PolygonAuction.resultAuction: Sender must be item owner"
        );
      });
      ...
      it("cannot result if auction has not ended", async () => {
        await expectRevert(
          ...
          "PolygonAuction.resultAuction: The auction has not ended"
        );
      });
      ...
      it("cannot result if the auction is reserve not reached", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.resultAuction: reserve not reached"
        );
      });
      ...
      it("cannot result if the auction has no winner", async () => {
        ...
        await expectRevert(
          ...
          "PolygonAuction.resultAuction: no open bids"
        );
      });
    ...
    describe("validation", async () => {
      it("cannot cancel if not an admin", async () => {
        await expectRevert(
          ...
          "PolygonAuction.cancelAuction: Sender must be item owner"
        );
      });
